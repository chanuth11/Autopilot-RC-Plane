...
#array (this does not have a funtion right now)
graph_length = 15
beta = []
alpha = []
...
while runner:
  ...
  pos_x = (temp[0] - original_x) *10000 #figure out what to multiply these two statements by for proper scaling.
  pos_y = (temp[1] - original_y) *10000
  print(pos_y)
